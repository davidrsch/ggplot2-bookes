...
-   Se cambió de `qplot()` a `ggplot()` en la introducción. Los comentarios indicaron que `qplot()` era una muleta: facilita un poco las tramas simples, pero no ayuda a dominar la gramática.
